...
<section className="relative min-h-screen bg-white overflow-hidden bg-cover bg-center" style={{ backgroundImage: "url('/bg5.jpg')" }}>
  ...
  <div className="relative z-50"> {/* Changed from just <Header /> */}
    <Header />
  </div>
              ...
              >
                {content.buttons.primary && (
                  <Link
                    ...
                    className="group w-full relative inline-flex items-center justify-center px-6 py-3 overflow-hidden text-white bg-blue-600 rounded-full transition-all duration-300 ease-out hover:ring-2 hover:ring-blue-600 hover:ring-offset-2 hover:bg-white hover:text-blue-600"
                  >
                ...
                {content.buttons.secondary && (
                  <Link
                    ...
                    className="group bg-white w-full relative inline-flex items-center justify-center px-6 py-3 overflow-hidden text-gray-900 border border-gray-200 rounded-full transition-all duration-300 ease-out hover:border-blue-600 hover:text-blue-600"
                  >
                    <span className="relative text-sm font-medium md:text-base">
                      {content.buttons.secondary.text}
                    </span>
                    <span className="absolute left-0 w-8 h-8 -ml-2 transform -translate-x-10 bg-blue-600 opacity-40 rotate-12 group-hover:translate-x-96 transition-all duration-300 ease-in-out" />
                  </Link>
                )}
              </motion.div>
            </motion.div>
