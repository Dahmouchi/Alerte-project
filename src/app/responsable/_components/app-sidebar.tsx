...
const datas = {
  ...
  navMain: [
    {
      title: "Accueil",
      url: "/responsable/dashboard/overview",
      icon: House,
    ...
    },
    {
      ...
      url: "/responsable/dashboard/cloture",
      icon: FolderLock,
    },
    {
      title: "Documentation",
      url: "/responsable/dashboard/documentation",
      icon: BookOpen,
...
export function AppSidebar({ ...props }: React.ComponentProps<typeof Sidebar>) {
  ...
  return (
   <Sidebar collapsible="icon" {...props} className="bg-white dark:bg-slate-800 p-2">
         ...
         <SidebarFooter>
        <Button
          onClick={() => signOut({ callbackUrl: "/responsable/login" })}
